 ...
 *
 * 
 * @author Jigsawfoley Date: 2018/03/09 
 * 
 * 
 *****************************************************************/
public class App {
	...
	public static void actionCommandlineInput(String args[]) {
...

		{
...

			{
				...
				System.out.println(
						"expecting	the	filename	to	be	specified	as	follows:	jdbc:sqlite:filepath\filename");
...

			{
...

				{
					...
					System.out.println("ERROR:	Database	file	does	not	exist	:	"
							+ (String) options.valueOf("database"));

					System.out.println(
							"If	the	file	is	in	the	same	directory	as	the	JAR	then	the	location	would	be:	databaseFileName.Extention");

					System.out.println(
							"for	windows	the	database	file	location	would	be:	C://folder/folder/databaseFileName.Extention");

					System.out.println(
							"for	MAC	the	database	file	location	would	be:	/Volumes/VolumeName/folder/folder/databaseFileName.Extention");
	...
	private static void printUsage(final OptionParser parser) {
		...
		catch (IOException ioEx) { // System.out.println("ERROR: Unable to print usage - " + ioEx);
